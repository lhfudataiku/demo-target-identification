  ...
  <div class="flex flex-col gap-6 p-6">
    ...
    <div class="grid grid-cols-12 gap-4">
      ...
      <VisualGraphExplorerCard
        ...
        description="Choose one of three evidence views, then open Visual Graph Explorer to run it. The presets show how the graph connects a disease to proteins, a familiar protein to pathways, and a familiar protein to drug context. Each query is ordered and bounded for a repeatable demonstration. For open-ended questions, use the Explorer's query generator."
      ...
      >
        <div class="rounded-lg border border-dashed border-border px-3.5 py-2.5 text-[11.5px] leading-relaxed text-muted-foreground">
          <p><b class="text-foreground">The three presets are deliberately distinct.</b> They introduce disease-associated proteins and their interactions, pathway context, and drug context without making a target or safety claim.</p>
          <p class="mt-1.5"><b class="text-foreground">Nothing runs in this app.</b> Selecting a preset only prepares its Cypher. The Explorer executes and displays one query result at a time.</p>
        </div>
      </VisualGraphExplorerCard>
