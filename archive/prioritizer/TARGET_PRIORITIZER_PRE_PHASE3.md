...
> **Lifecycle:** Historical · **Superseded by:**
> [`docs/prioritizer/TARGET_PRIORITIZER.md`](../../docs/prioritizer/TARGET_PRIORITIZER.md) for the
> current modelling method and [`docs/prioritizer/VALIDATION.md`](../../docs/prioritizer/VALIDATION.md)
> for current validation evidence · **Frozen:** 2026-08-29 at the Phase 3 method/evidence split.
